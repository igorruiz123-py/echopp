...
<p>
    <i>
        The command "<strong>make build</strong>" sets up the directory environment needed to place the compiled binaries that will be generated by the compilation.
    </i>
</p>
...
<pre>
    <code class="language-bash">make build</code>
</pre>